      ...
      {parts.map((p, i) =>
        p.type === 'citation' ? (
          <button
            ...
            onMouseEnter={e => { if (p.nodeId) e.currentTarget.style.background = 'rgba(124,58,237,0.35)' }}
            onMouseLeave={e => { if (p.nodeId) e.currentTarget.style.background = 'rgba(124,58,237,0.2)' }}
          >
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '12px 14px' }}>
        ...
        {messages.map(msg => (
          ...
          >
            ...
            <div style={{
              ...
              background: msg.role === 'user' ? 'rgba(124,58,237,0.3)' : 'rgba(124,58,237,0.15)',
              border: `1px solid ${msg.role === 'user' ? '#7c3aed' : '#4c1d95'}`,
            ...
            <div style={{
              ...
              border: `1px solid ${msg.role === 'user' ? 'rgba(124,58,237,0.4)' : 'var(--border)'}`,
              ...
              {msg.role === 'assistant' && msg.relevant?.length > 0 && (
                <div style={{ marginTop: 7, paddingTop: 7, borderTop: '1px solid rgba(42,42,74,0.6)' }}>
                  <div style={{ fontSize: 9, color: 'var(--text-muted)', letterSpacing: '0.06em', marginBottom: 4, fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase' }}>
        ...
        {loading && messages.length > 0 && messages[messages.length - 1]?.role === 'user' && (
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', padding: '4px 0' }}>
            <div style={{ width: 22, height: 22, borderRadius: '50%', background: 'rgba(124,58,237,0.15)', border: '1px solid #4c1d95', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10 }}>⚡</div>
        ...
        {!hasKey ? (
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'flex-end' }}>
            ...
            <button
              ...
              style={{
                width: 34, height: 34,
                background: input.trim() && !loading ? 'linear-gradient(135deg, #6d28d9, #5b21b6)' : 'rgba(42,42,74,0.5)',
                border: `1px solid ${input.trim() && !loading ? '#7c3aed' : 'var(--border)'}`,
                borderRadius: 8,
                ...
                flexShrink: 0,
                boxShadow: input.trim() && !loading ? '0 0 8px #7c3aed33' : 'none',
              }}
            >
